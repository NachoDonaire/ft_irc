...
Channel::Channel(): users(0), admins(0), topic(""), id(""), password(""), maxUsers(MAX_USERS_PER_CHANNEL), inviteMode(false), topicRestriction(false)
{
//Const
}
